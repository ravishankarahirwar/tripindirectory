package directory.tripin.com.tripindirectory.Messaging.Activity;
...
import directory.tripin.com.tripindirectory.Messaging.Class.Report;
import directory.tripin.com.tripindirectory.Messaging.Class.User;
import directory.tripin.com.tripindirectory.Messaging.Fragment.ChatFragment;
...
public class ChatActivity extends BaseActivity {
   ...
   // private Toolbar mToolbar;
    ...
    protected void onResume() {
        super.onResume();
        TripinDirectoryApp.setChatActivityOpen(true);
    }

    @Override
    protected void onPause() {
        super.onPause();
        TripinDirectoryApp.setChatActivityOpen(false);
    }
}

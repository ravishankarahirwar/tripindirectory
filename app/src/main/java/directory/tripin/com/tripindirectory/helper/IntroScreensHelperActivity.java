...
public abstract class IntroScreensHelperActivity extends LocalizationActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.codemybrainsout.onboarder.R.layout.activity_ahoy);
        setStatusBackgroundColor();
        hideActionBar();

        parentLayout = (RelativeLayout) findViewById(com.codemybrainsout.onboarder.R.id.parent_layout);
        circleIndicatorView = (CircleIndicatorView) findViewById(com.codemybrainsout.onboarder.R.id.circle_indicator_view);
        btnSkip = (TextView) findViewById(com.codemybrainsout.onboarder.R.id.btn_skip);
        buttonsLayout = (FrameLayout) findViewById(com.codemybrainsout.onboarder.R.id.buttons_layout);
        navigationControls = (FrameLayout) findViewById(com.codemybrainsout.onboarder.R.id.navigation_layout);
        ivNext = (ImageView) findViewById(com.codemybrainsout.onboarder.R.id.ivNext);
        ivPrev = (ImageView) findViewById(com.codemybrainsout.onboarder.R.id.ivPrev);
        backgroundImage = (ImageView) findViewById(com.codemybrainsout.onboarder.R.id.background_image);
        backgroundImageOverlay = (View) findViewById(com.codemybrainsout.onboarder.R.id.background_image_overlay);
        vpOnboarderPager = (ViewPager) findViewById(com.codemybrainsout.onboarder.R.id.vp_pager);
